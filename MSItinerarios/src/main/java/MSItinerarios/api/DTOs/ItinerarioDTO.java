...
public class ItinerarioDTO {
    ...
    public int cabines_disponiveis;

    public ItinerarioDTO(int id, String[] datas_de_partida_disponiveis, String nome_do_navio, String porto_de_embarque, String porto_de_desembarque, String lugares_visitados, String numero_de_noites, String valor_por_pessoa, int cabines_disponiveis) {
        this.id = id;
        ...
        this.cabines_disponiveis = cabines_disponiveis;
    }
}
